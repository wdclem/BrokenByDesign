...
- **Start here (Challenge 01):** **[challenges/01-broken-frontend/SPEC.md](challenges/01-broken-frontend/SPEC.md)** — open this file to see your Jira-style ticket, acceptance criteria, and what to do. Then run the app from `challenges/01-broken-frontend/app/` (see that folder's README for `npm install` and `npm run dev`).

So: fork → clone your fork → read the spec above → run the app → fix → PR on your fork.
...
2. **Read your instructions:** [Challenge 01 spec](challenges/01-broken-frontend/SPEC.md) (ticket + task).
